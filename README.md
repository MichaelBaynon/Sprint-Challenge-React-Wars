...
React is a JS library for building UI. React makes it way easier then what vanilla JS is and its way quicker, more streamlined and more organized.

- [ ] What does it mean to _think_ in react?
Thinking in react is looking at every piece of a webpage or design file and breaking it down into its functionality or as  a "compoonent" this allows us to clearly lay out a plan for design.

- [ ] Describe state.
state is an object that represents the parts of the application that are subject to change or can change each object can have its own state

- [ ] Describe props.
props is using in react to basically share code or data around components
